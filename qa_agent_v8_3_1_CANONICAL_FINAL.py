...
REPORT_DIR = Path("qa_v8_3_report")
...
# ============================================================
# V8.3.1 INTEGRATED UNKNOWN-BEHAVIOR CLOSURE
# ============================================================
    ...
    async with async_playwright() as p:
        ...
        for behavior in unknown[:V828_MAX_CLOSURE_ROUNDS]:
            ...
            if result.get("status") == "PASS":
                ...
                self.results.append({
                    "name": f"V8.3.1 Closure: {behavior.get('description', behavior.get('action'))}",
...
def _v828_write_closure_artifact(self, closure):
    ...
    payload = {
        "version": "8.2.8",
        "engine": "integrated_unknown_behavior_closure",
        "closure": closure,
    ...
    print(f"\n📄 V8.3.1 closure artifact: {path.absolute()}")
...
# ============================================================
# V8.3.1 EXECUTION PROVENANCE & EVIDENCE INTEGRITY
# ============================================================
...
def _v829_print_provenance(report):
    print("\n" + "=" * 70)
    print("🔎 V8.3.1 EXECUTION PROVENANCE & EVIDENCE INTEGRITY")
    print("=" * 70)
...
# ============================================================
# END V8.3.1 PROVENANCE ENGINE
# ============================================================


# ============================================================
# V8.3 VERSION TRUTH + EVIDENCE TRUTH GATES
# ============================================================
...
def _v8210_print_truth_gate(truth):
    print("\n" + "=" * 70)
    print("🛡️ V8.3 VERSION TRUTH + EVIDENCE TRUTH")
    print("=" * 70)
    ...
    if truth["truth_gate"] == "PASS":
        print("\n   🟢 V8.3.1 TRUTH GATE: PASS")
    else:
        print("\n   🔴 V8.3.1 TRUTH GATE: FAIL")
...
# ============================================================
# END V8.3.1 TRUTH GATES
# ============================================================



# ============================================================
# V8.3 SINGLE SOURCE OF TRUTH
# ============================================================

V8211_VERSION = "8.3.1"

# V8.3.1 PATCH: authoritative version + risk-based evidence truth.
V8211_PATCH_LEVEL = "8.3.1-final | V8.3-business-journeys"


def _v8211_version_from_text(value):
    """
    Extract an authoritative V8.3.1 declaration.
...
def _v8211_print_truth_gate(truth):
    print("\n" + "=" * 70)
    print("🛡️ V8.3 SINGLE SOURCE OF TRUTH")
    print("=" * 70)
...
# ============================================================
# END V8.3 SINGLE SOURCE OF TRUTH
# ============================================================



# ============================================================
# V8.3 TRUE AUTONOMOUS BUSINESS-JOURNEY DISCOVERY
# ============================================================

V83_VERSION = "8.3"


V83_RELEASE_MARKER = "V8.3-FINAL-HARDENED"
...
def _v83_print_release_truth(truth):
    print("\n" + "=" * 70)
    print("🧭 V8.3 BUSINESS-JOURNEY RELEASE TRUTH")
    print("=" * 70)
    print(
    ...
    print(
        f"\n   {'🟢' if truth['pass'] else '🔴'} "
        f"V8.3 RELEASE TRUTH GATE: {'PASS' if truth['pass'] else 'FAIL'}"
    )
    print("=" * 70)
...
def _v83_print_canonical_journey_truth(truth):
    print("\n" + "=" * 70)
    print("🧭 V8.3 AUTONOMOUS BUSINESS-JOURNEY TRUTH")
    print("=" * 70)
...
def _v83_write_business_artifacts(agent, graph, journeys, executions):
    ...
    print("\n" + "=" * 70)
    print("🧭 V8.3 TRUE AUTONOMOUS BUSINESS-JOURNEY DISCOVERY")
    print("=" * 70)
    ...
    print(f"📄 Canonical V8.3 state: {cpath}")
    print("=" * 70)
...
# ============================================================
# END V8.3 BUSINESS-JOURNEY ENGINE
# ============================================================
...
class QAAgent:
    ...
    async def _v828_run_unknown_behavior_closure(self):
        ...
        print("\n" + "=" * 70)
        print("🧠 V8.3.1 UNKNOWN-BEHAVIOR CLOSURE")
        print("=" * 70)
...
""".format(
    ...
    def _v70_print_mission(self):
        ...
        print("\n")
        print("=" * 70)
        print("🎯 V8.3.1 AUTONOMOUS QA MISSION")
        print("=" * 70)
    ...
    def _v824_mission_truth(self):
        ...
        V8.3.1 could print 100% while reporting zero behaviors. V8.3.1
    ...
    def _v76_print(self):
        ...
        print("\n" + "=" * 70)
        print("🔄 V8.3.1 EXECUTABLE TEST-INTENT INTELLIGENCE")
        print("=" * 70)
    ...
    # ========================================================
    # V8.3.1 BEHAVIOR MODEL + BUSINESS JOURNEY DISCOVERY
    # ========================================================
    ...
    async def run(self):
        ...
        # V8.3.1: construct behavioral entities and business-journey hypotheses.
        self._v826_build_behavior_model()

        # V8.3: discover and safely exercise cross-page business journeys.
        ...
        # V8.3.1: link execution evidence back to the behavior model.
        self._v826_sync_behavior_coverage()
        self._v826_write_behavior_artifact()

        # V8.3.1: actually execute high-risk unknown behaviors.
        ...
        # V8.3.1: legacy truth gates are retained for compatibility but are NOT authoritative.
        ...
        if closure_status == "CLOSED":
            print("\n🟢 V8.3 UNKNOWN-BEHAVIOR GATE: PASS")
        elif closure_status == "OPEN":
            print("\n🟡 V8.3 UNKNOWN-BEHAVIOR GATE: OPEN")
        else:
            print("\n🟠 V8.3 UNKNOWN-BEHAVIOR GATE: MODEL_REQUIRED")
        if mission_truth["status"] == "NOT_MEASURABLE":
            print("\n🛡️ V8.3.1 MISSION TRUTH GATE: PASS")
    ...
    #
    # V8.3.1 produces an auditable quality decision without
    # storing credentials, tokens, cookies, passwords, or secrets.
    # ========================================================

    def _v78_execution_truth(self):
        # V8.3.1: quality truth is derived from the same classified
    ...
    def _v78_write_quality_truth(self):
        ...
        try:
            ...
            print(
                f"\n⚠️ V8.3.1 quality-truth artifact "
                f"write skipped: {exc}"
            )
    ...
    # ============================================================
    # V8.3 EXECUTABLE TEST-INTENT QUALITY GATES
    # ============================================================
    ...
    def _v8_print_e2e_quality(self):
        ...
        print("\n")
        print("=" * 70)
        print("🧭 V8.3 EXECUTABLE TEST-INTENT QUALITY")
        print("=" * 70)
    ...
    def _v81_print_intent_engine(self):
        ...
        print("\n")
        print("=" * 70)
        print("🧠 V8.3 AUTONOMOUS TEST-INTENT ENGINE")
        print("=" * 70)
    ...
    def _v821_classified_execution_counts(self):
        """V8.3.1 authoritative intent-aware execution accounting.
        ...
        V8.3.1 uses the single V8 classifier so all reporting layers agree.
        """
        counts = {
        ...
        if counts["TOTAL"]["executed"] != len(executable):
            raise AssertionError(
                "V8.3.1 execution accounting mismatch: "
    ...
    def _v82_reconcile_execution_state(self):
        ...
        for item in results:
            ...
            # Use the same classifier as every other V8.3.1 truth layer.
            kind = self._v8_classify_test(item)
    ...
    def _v82_print_canonical_state(self):
        ...
        print("\n")
        print("=" * 70)
        print("🧩 V8.3 CANONICAL QA RUN STATE")
        print("=" * 70)
    ...
    def _v822_validate_execution_truth(self):
        ...
        if total["executed"] != total["passed"] + total["failed"]:
            raise AssertionError(
                "V8.3.1 invariant failed: executed != passed + failed"
            )
        ...
        for kind in ("SMOKE", "SANITY", "REGRESSION", "E2E"):
            ...
            if row["executed"] != row["passed"] + row["failed"]:
                raise AssertionError(
                    f"V8.3.1 invariant failed for {kind}: "
        ...
        if classified_generated != (
            ...
            raise AssertionError(
                "V8.3.1 generated-intent execution ledger mismatch"
            )

        print("\n🛡️ V8.3 EXECUTION TRUTH GATE: PASS")
        print(
    ...
    def _v825_validate_behavioral_mission(self):
        ...
        if truth.get("status") == "MODEL_REQUIRED":
            print("\n🧠 V8.3.1 BEHAVIOR MODEL GATE: MODEL_REQUIRED")
    ...
    def report(self):
        ...
        print(
            "📊 V8.3 EXECUTABLE TEST-INTENT QUALITY REPORT"
        )
...
# ============================================================
# V8.3.1 CANONICAL RELEASE TRUTH
# ============================================================
...
def _v831_evidence_required(result):
    """Evidence is mandatory for failures and risk-bearing exploration."""
    status = str(result.get("status", "")).upper()
    provenance = str(
        result.get("provenance")
        or result.get("source")
    ...
    return (
        status == "FAIL"
        or "CLOSURE" in provenance
        or "EXPLOR" in provenance
        or bool(result.get("defect"))
        or bool(result.get("confirmed_defect"))
    )
...
def _v831_canonical_truth(agent):
    results = list(getattr(agent, "results", []) or [])
    ...
    for i, r in enumerate(results, 1):
        if not r.get("execution_id"):
            evidence_violations.append({"record": i, "missing": "execution_id"})
        if _v831_evidence_required(r) and not _v831_has_evidence(r):
            evidence_violations.append({"record": i, "missing": "evidence"})
    ...
    if not isinstance(closure, dict):
        closure = getattr(agent, "v828_unknown_behavior_closure", {}) or {}
    unknown_remaining = int(closure.get("unknown", 0) or 0) if isinstance(closure, dict) else 0
    closure_closed = str(closure.get("status", "" )).upper() == "CLOSED" if isinstance(closure, dict) else False

    # Prefer the actual behavioral truth produced by V8.3.
    coverage = None
    coverage_total = 0
    coverage_covered = 0
    try:
...
def _v831_finalize_canonical_truth(agent):
    ...
    if truth["release_gate"] == "PASS":
        print("\n   🟢 V8.3.1 RELEASE TRUTH GATE: PASS")
    else:
        print("\n   🔴 V8.3.1 RELEASE TRUTH GATE: FAIL")
...
async def main():
    args = _v79_parse_cli()
    url = args.url
    print("\n*** RUNNING qa_agent_v8_3_1_CANONICAL_FINAL.py — VERSION 8.3.1 FINAL ***\n")
