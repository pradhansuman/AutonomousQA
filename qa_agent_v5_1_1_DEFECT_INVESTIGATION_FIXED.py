...
REPORT_DIR = Path("qa_v5_1_1_defect_investigation_report")
...
class QAAgent:
    ...
    def report(self):
        ...
        print(
            "📊 V5.1.1 DEFECT INVESTIGATION QA REPORT"
        )
...
async def main():
    print("\n*** RUNNING qa_agent_v5_1_DEFECT_INVESTIGATION_FINAL.py — VERSION 5.1.1 DEFECT INVESTIGATION FIXED ***\n")
