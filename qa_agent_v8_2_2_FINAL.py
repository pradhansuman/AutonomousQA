...
""".format(
    ...
    def _v70_print_mission(self):
        ...
        print("\n")
        print("=" * 70)
        print("🎯 V8.2.2 AUTONOMOUS QA MISSION")
        print("=" * 70)
    ...
    def _v76_print(self):
        ...
        print("\n" + "=" * 70)
        print("🔄 V8.2 EXECUTABLE TEST-INTENT INTELLIGENCE")
        print("=" * 70)
    ...
    def _v76_write_artifact(self):
        try:
            (REPORT_DIR / "qa_change_intelligence_v8_2_2.json").write_text(
                json.dumps({
                    "version": "7.6",
                    "change_risk": getattr(self, "v76_change_risk", 0),
            ...
            print(f"\n📄 Change-intelligence artifact: {(REPORT_DIR / 'qa_change_intelligence_v8_2_2.json').absolute()}")
        except Exception as exc:
    ...
    #
    # V8.2.2 produces an auditable quality decision without
    # storing credentials, tokens, cookies, passwords, or secrets.
    # ========================================================

    def _v78_execution_truth(self):
        # V8.2.2: quality truth is derived from the same classified
    ...
    def _v78_write_quality_truth(self):
        ...
        try:
            ...
            print(
                f"\n⚠️ V8.2.2 quality-truth artifact "
                f"write skipped: {exc}"
            )
    ...
    def _v81_print_intent_engine(self):
        ...
        print("\n")
        print("=" * 70)
        print("🧠 V8.1 AUTONOMOUS TEST-INTENT ENGINE")
        print("=" * 70)
    ...
    def _v821_classified_execution_counts(self):
        """V8.2.2 authoritative intent-aware execution accounting.
        ...
        V8.2.2 uses the single V8 classifier so all reporting layers agree.
        """
        counts = {
        ...
        if counts["TOTAL"]["executed"] != len(executable):
            raise AssertionError(
                "V8.2.2 execution accounting mismatch: "
    ...
    def _v82_reconcile_execution_state(self):
        ...
        for item in results:
            ...
            # Use the same classifier as every other V8.2.2 truth layer.
            kind = self._v8_classify_test(item)
    ...
    def _v822_validate_execution_truth(self):
        ...
        if total["executed"] != total["passed"] + total["failed"]:
            raise AssertionError(
                "V8.2.2 invariant failed: executed != passed + failed"
            )
        ...
        for kind in ("SMOKE", "SANITY", "REGRESSION", "E2E"):
            ...
            if row["executed"] != row["passed"] + row["failed"]:
                raise AssertionError(
                    f"V8.2.2 invariant failed for {kind}: "
        ...
        if classified_generated != (
            ...
            raise AssertionError(
                "V8.2.2 generated-intent execution ledger mismatch"
            )

        print("\n🛡️ V8.2.2 EXECUTION TRUTH GATE: PASS")
        print(
