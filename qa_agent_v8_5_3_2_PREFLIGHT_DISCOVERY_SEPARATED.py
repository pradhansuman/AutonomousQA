...
# ============================================================================
# V8.5.3.2 — TRUE OBSERVABILITY / EVIDENCE CORRELATION
# ============================================================================
V852_VERSION = "8.5.2"
...
def _v85_write_truth(model, truth):
    d=Path("qa_v8_5_3_2_report"); d.mkdir(parents=True,exist_ok=True)
    mp=d/"qa_business_outcome_verification_v8_5_3_2.json"; tp=d/"qa_v8_5_3_2_business_outcome_truth.json"
    ...
    print("\n"+"="*70); print("🧭 V8.5.3.2 TRUE OBSERVABILITY / BUSINESS-OUTCOME TRUTH"); print("="*70)
    ...
    print(f"\n   {'🟢' if truth['pass'] else '🔴'} V8.5.3.2 EVIDENCE TRUTH GATE: {'PASS' if truth['pass'] else 'FAIL'}"); print("="*70); print(f"📄 Outcome verification: {mp}"); print(f"📄 Outcome truth: {tp}")


# ============================================================================
# V8.5.3.2 — FAIL-CLOSED AUTONOMOUS EXECUTION INTEGRITY
# ============================================================================
#
...
def _v853_write_integrity_artifact(payload):
    report_dir = Path("qa_v8_5_3_2_report")
    report_dir.mkdir(parents=True, exist_ok=True)
    path = report_dir / "qa_execution_integrity_v8_5_3_2.json"
    path.write_text(
...
def _v853_print_blocked_truth(payload, artifact):
    print("\n" + "=" * 70)
    print("🛡️ V8.5.3.2 FAIL-CLOSED EXECUTION INTEGRITY")
    print("=" * 70)
...
async def main():
    ...
    print("\n*** RUNNING qa_agent_v8_5_3_2_FAIL_CLOSED_EXECUTION_INTEGRITY.py — VERSION 8.5.3.1 ***\n")

    if not url.startswith(("http://", "https://")):
        print("❌ Invalid URL")
        sys.exit(1)

    # CRITICAL V8.5.3.2 RULE:
    ...
    print("🛡️ V8.5.3.2 CURRENT-RUN DISCOVERY PREFLIGHT")
    ...
    if not preflight.get("ok"):
        ...
        artifact = _v853_write_integrity_artifact(payload)
        _v853_print_blocked_truth(payload, artifact)
        print("🔴 V8.5.3.2 STOP: agent execution was NOT started.")
        raise SystemExit(3)
