...
""".format(
    ...
    def _v76_print(self):
        ...
        print("\n" + "=" * 70)
        print("🔄 V7.7 FAILURE-CLASSIFICATION QA INTELLIGENCE")
        print("=" * 70)
    ...
    def _v76_write_artifact(self):
        try:
            (REPORT_DIR / "qa_change_intelligence_v7_7.json").write_text(
                json.dumps({
                    "version": "7.6",
                    "change_risk": getattr(self, "v76_change_risk", 0),
            ...
            print(f"\n📄 Change-intelligence artifact: {(REPORT_DIR / 'qa_change_intelligence_v7_7.json').absolute()}")
        except Exception as exc:
    ...
    def _v77_run_failure_classification(self):
        ...
        if report_dir:
            try:
                ...
                artifact = (
                    out_dir
                    / "qa_failure_classification_v7_7.json"
                )
    ...
    def report(self):
        ...
        print(
            "📊 V7.7 FAILURE-CLASSIFICATION AUTONOMOUS QA REPORT"
        )
