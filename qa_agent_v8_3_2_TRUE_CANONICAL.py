...
class QAAgent:
    ...
    async def _v828_run_unknown_behavior_closure(self):
        ...
        # V8.3.2 FIX:
        # Persist the actual closure result on the agent.  The V8.3.1
        ...
        print("\n" + "=" * 70)
        print("🧠 V8.3.2 UNKNOWN-BEHAVIOR CLOSURE")
        print("=" * 70)
...
# ============================================================
# V8.3.2 CANONICAL RELEASE TRUTH
# ============================================================
...
def _v831_evidence_required(result):
    """V8.3.2 canonical rule: every executed record needs an evidence envelope."""
    return True
...
def _v831_finalize_canonical_truth(agent):
    ...
    print("\n" + "=" * 70)
    print("🛡️ V8.3.2 CANONICAL RELEASE TRUTH")
    print("=" * 70)
    ...
    if truth["release_gate"] == "PASS":
        print("\n   🟢 V8.3.2 RELEASE TRUTH GATE: PASS")
    else:
        print("\n   🔴 V8.3.2 RELEASE TRUTH GATE: FAIL")
