...
VERSION = "8.7.14"
REPORT_DIR = Path("qa_v8_7_14_report")
...
class Agent:
    ...
    def write(self,truth):
        ...
        (REPORT_DIR/"qa_v8_7_14_canonical_truth.json").write_text(
    ...
    async def run(self):
        ...
        async with async_playwright() as p:
            ...
            self.write(truth)
            await browser.close()
            self.log(f"📄 Canonical truth: {REPORT_DIR/'qa_v8_7_14_canonical_truth.json'}")
