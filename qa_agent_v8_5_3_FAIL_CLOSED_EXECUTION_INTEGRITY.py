...
async def main():
    ...
    print("\n*** RUNNING qa_agent_v8_5_3_TRUE_OBSERVABILITY.py — VERSION 8.5.2 ***\n")
    ...
    # V8.5.3 integrity barrier:
    # discovery must establish the current application before any downstream
    # legacy/canonical reporting is allowed to represent this run as healthy.
