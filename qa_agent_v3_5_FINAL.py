...
REPORT_DIR = Path("qa_v3_5_report")
...
def classify(e):
    ...
    # IMPORTANT: special input types must be classified
...
async def main():
    print("\n*** RUNNING qa_agent_v3_5_FINAL.py — VERSION 3.5 FINAL ***\n")
