...
REPORT_DIR = Path("qa_v8_4_report")
...
# ============================================================
# V8.4.1 INTEGRATED UNKNOWN-BEHAVIOR CLOSURE
# ============================================================
    ...
    async with async_playwright() as p:
        ...
        for behavior in unknown[:V828_MAX_CLOSURE_ROUNDS]:
            ...
            if result.get("status") == "PASS":
                ...
                self.results.append({
                    "name": f"V8.4.1 Closure: {behavior.get('description', behavior.get('action'))}",
...
def _v828_write_closure_artifact(self, closure):
    path = REPORT_DIR / "qa_unknown_behavior_closure_v8_4.json"
    payload = {
        "version": "8.3.2",
    ...
    print(f"\n📄 V8.4.1 closure artifact: {path.absolute()}")
...
# ============================================================
# V8.4.1 EXECUTION PROVENANCE & EVIDENCE INTEGRITY
# ============================================================
...
def _v829_write_provenance_artifact(report_dir, results):
    ...
    path = Path(report_dir) / "qa_execution_provenance_v8_4.json"
    path.write_text(
...
def _v829_print_provenance(report):
    print("\n" + "=" * 70)
    print("🔎 V8.4.1 EXECUTION PROVENANCE & EVIDENCE INTEGRITY")
    print("=" * 70)
...
# ============================================================
# END V8.4.1 PROVENANCE ENGINE
# ============================================================


# ============================================================
# V8.4 VERSION TRUTH + EVIDENCE TRUTH GATES
# ============================================================
...
def _v8210_write_truth_artifact(report_dir, truth):
    path = Path(report_dir) / "qa_truth_gate_v8_4.json"
    path.write_text(
...
def _v8210_print_truth_gate(truth):
    print("\n" + "=" * 70)
    print("🛡️ V8.4 VERSION TRUTH + EVIDENCE TRUTH")
    print("=" * 70)
    ...
    if truth["truth_gate"] == "PASS":
        print("\n   🟢 V8.4.1 TRUTH GATE: PASS")
    else:
        print("\n   🔴 V8.4.1 TRUTH GATE: FAIL")
...
# ============================================================
# END V8.4.1 TRUTH GATES
# ============================================================



# ============================================================
# V8.4 SINGLE SOURCE OF TRUTH
# ============================================================

V8211_VERSION = "8.3.1"

# V8.4.1 PATCH: authoritative version + risk-based evidence truth.
V8211_PATCH_LEVEL = "8.3.1-final | V8.4-business-journeys"


def _v8211_version_from_text(value):
    """
    Extract an authoritative V8.4.1 declaration.
...
def _v8211_write_truth_artifact(report_dir, truth):
    path = Path(report_dir) / "qa_truth_single_source_v8_4.json"
    path.write_text(
        json.dumps(truth, indent=2, ensure_ascii=False, default=str),
        encoding="utf-8",
    )
...
def _v8211_print_truth_gate(truth):
    print("\n" + "=" * 70)
    print("🛡️ V8.4 SINGLE SOURCE OF TRUTH")
    print("=" * 70)
...
# ============================================================
# END V8.4 SINGLE SOURCE OF TRUTH
# ============================================================



# ============================================================
# V8.4 TRUE AUTONOMOUS BUSINESS-JOURNEY DISCOVERY
# ============================================================

V83_VERSION = "8.3"


V83_RELEASE_MARKER = "V8.4-FINAL-HARDENED"
...
def _v83_print_release_truth(truth):
    print("\n" + "=" * 70)
    print("🧭 V8.4 BUSINESS-JOURNEY RELEASE TRUTH")
    print("=" * 70)
    print(
    ...
    print(
        f"\n   {'🟢' if truth['pass'] else '🔴'} "
        f"V8.4 RELEASE TRUTH GATE: {'PASS' if truth['pass'] else 'FAIL'}"
    )
    print("=" * 70)
...
def _v83_print_canonical_journey_truth(truth):
    print("\n" + "=" * 70)
    print("🧭 V8.4 AUTONOMOUS BUSINESS-JOURNEY TRUTH")
    print("=" * 70)
...
def _v83_write_business_artifacts(agent, graph, journeys, executions):
    ...
    print("\n" + "=" * 70)
    print("🧭 V8.4 TRUE AUTONOMOUS BUSINESS-JOURNEY DISCOVERY")
    print("=" * 70)
    ...
    print(f"📄 Canonical V8.4 state: {cpath}")
    print("=" * 70)
...
# ============================================================
# END V8.4 BUSINESS-JOURNEY ENGINE
# ============================================================
...
class QAAgent:
    ...
    async def _v828_run_unknown_behavior_closure(self):
        ...
        # V8.4 FIX:
        # Persist the actual closure result on the agent.  The V8.4.1
        ...
        print("\n" + "=" * 70)
        print("🧠 V8.4 UNKNOWN-BEHAVIOR CLOSURE")
        print("=" * 70)
...
""".format(
    ...
    def _v70_print_mission(self):
        ...
        print("\n")
        print("=" * 70)
        print("🎯 V8.4.1 AUTONOMOUS QA MISSION")
        print("=" * 70)
    ...
    def _v824_mission_truth(self):
        ...
        V8.4.1 could print 100% while reporting zero behaviors. V8.4.1
    ...
    def _v76_print(self):
        ...
        print("\n" + "=" * 70)
        print("🔄 V8.4.1 EXECUTABLE TEST-INTENT INTELLIGENCE")
        print("=" * 70)
    ...
    # ========================================================
    # V8.4.1 BEHAVIOR MODEL + BUSINESS JOURNEY DISCOVERY
    # ========================================================
    ...
    def _v826_write_behavior_artifact(self):
        try:
            path=REPORT_DIR/"qa_behavior_model_v8_4.json"
    ...
    async def run(self):
        ...
        # V8.4.1: construct behavioral entities and business-journey hypotheses.
        self._v826_build_behavior_model()

        # V8.4: discover and safely exercise cross-page business journeys.
        ...
        # V8.4.1: link execution evidence back to the behavior model.
        self._v826_sync_behavior_coverage()
        self._v826_write_behavior_artifact()

        # V8.4.1: actually execute high-risk unknown behaviors.
        ...
        # V8.4.1: legacy truth gates are retained for compatibility but are NOT authoritative.
        ...
        if closure_status == "CLOSED":
            print("\n🟢 V8.4 UNKNOWN-BEHAVIOR GATE: PASS")
        elif closure_status == "OPEN":
            print("\n🟡 V8.4 UNKNOWN-BEHAVIOR GATE: OPEN")
        else:
            print("\n🟠 V8.4 UNKNOWN-BEHAVIOR GATE: MODEL_REQUIRED")
        if mission_truth["status"] == "NOT_MEASURABLE":
            print("\n🛡️ V8.4.1 MISSION TRUTH GATE: PASS")
    ...
    #
    # V8.4.1 produces an auditable quality decision without
    # storing credentials, tokens, cookies, passwords, or secrets.
    # ========================================================

    def _v78_execution_truth(self):
        # V8.4.1: quality truth is derived from the same classified
    ...
    def _v78_write_quality_truth(self):
        ...
        try:
            ...
            print(
                f"\n⚠️ V8.4.1 quality-truth artifact "
                f"write skipped: {exc}"
            )
    ...
    # ============================================================
    # V8.4 EXECUTABLE TEST-INTENT QUALITY GATES
    # ============================================================
    ...
    def _v8_print_e2e_quality(self):
        ...
        print("\n")
        print("=" * 70)
        print("🧭 V8.4 EXECUTABLE TEST-INTENT QUALITY")
        print("=" * 70)
    ...
    def _v81_print_intent_engine(self):
        ...
        print("\n")
        print("=" * 70)
        print("🧠 V8.4 AUTONOMOUS TEST-INTENT ENGINE")
        print("=" * 70)
    ...
    def _v821_classified_execution_counts(self):
        """V8.4.1 authoritative intent-aware execution accounting.
        ...
        V8.4.1 uses the single V8 classifier so all reporting layers agree.
        """
        counts = {
        ...
        if counts["TOTAL"]["executed"] != len(executable):
            raise AssertionError(
                "V8.4.1 execution accounting mismatch: "
    ...
    def _v82_reconcile_execution_state(self):
        ...
        for item in results:
            ...
            # Use the same classifier as every other V8.4.1 truth layer.
            kind = self._v8_classify_test(item)
    ...
    def _v82_print_canonical_state(self):
        ...
        print("\n")
        print("=" * 70)
        print("🧩 V8.4 CANONICAL QA RUN STATE")
        print("=" * 70)
    ...
    def _v822_validate_execution_truth(self):
        ...
        if total["executed"] != total["passed"] + total["failed"]:
            raise AssertionError(
                "V8.4.1 invariant failed: executed != passed + failed"
            )
        ...
        for kind in ("SMOKE", "SANITY", "REGRESSION", "E2E"):
            ...
            if row["executed"] != row["passed"] + row["failed"]:
                raise AssertionError(
                    f"V8.4.1 invariant failed for {kind}: "
        ...
        if classified_generated != (
            ...
            raise AssertionError(
                "V8.4.1 generated-intent execution ledger mismatch"
            )

        print("\n🛡️ V8.4 EXECUTION TRUTH GATE: PASS")
        print(
    ...
    def _v825_validate_behavioral_mission(self):
        ...
        if truth.get("status") == "MODEL_REQUIRED":
            print("\n🧠 V8.4.1 BEHAVIOR MODEL GATE: MODEL_REQUIRED")
    ...
    def report(self):
        ...
        print(
            "📊 V8.4 EXECUTABLE TEST-INTENT QUALITY REPORT"
        )
...
def _v831_evidence_required(result):
    """V8.4 canonical rule: every executed record needs an evidence envelope."""
    return True
...
def _v831_canonical_truth(agent):
    ...
    # Prefer the actual behavioral truth produced by V8.4.
    coverage = None
    coverage_total = 0
    coverage_covered = 0
    try:
...
def _v831_finalize_canonical_truth(agent):
    ...
    print("\n" + "=" * 70)
    print("🛡️ V8.4 CANONICAL RELEASE TRUTH")
    print("=" * 70)
    ...
    if truth["release_gate"] == "PASS":
        print("\n   🟢 V8.4 RELEASE TRUTH GATE: PASS")
    else:
        print("\n   🔴 V8.4 RELEASE TRUTH GATE: FAIL")
...
# ============================================================================
# V8.4 AUTONOMOUS BUSINESS-OUTCOME INTELLIGENCE
# ============================================================================
...
def _v84_release_truth(outcome_model, journey_truth):
    ...
    # for execution truth; V8.4 only validates outcome classification.
    journeys_ok = (
...
def _v84_write_truth(outcome_model, release_truth):
    ...
    outcome_path = report_dir / "qa_business_outcome_model_v8_4.json"
    truth_path = report_dir / "qa_v8_4_business_outcome_truth.json"
    ...
    print("\n" + "=" * 70)
    print("🧭 V8.4 AUTONOMOUS BUSINESS-OUTCOME TRUTH")
    print("=" * 70)
    ...
    print(
        ...
        f"V8.4 BUSINESS-OUTCOME RELEASE GATE: "
        f"{'PASS' if release_truth['pass'] else 'FAIL'}"
    )
    print("=" * 70)
    print(f"📄 Business-outcome model: {outcome_path}")
    print(f"📄 V8.4 outcome truth: {truth_path}")


async def main():
    args = _v79_parse_cli()
    url = args.url
    print("\n*** RUNNING qa_agent_v8_4_AUTONOMOUS_BUSINESS_OUTCOME.py — VERSION 8.4 FINAL ***\n")
    ...
    # V8.4 consumes the already-executed journey evidence.
    def _v84_extract_journey_evidence(obj):
        """Extract journey discovery/execution evidence without inventing it."""
        journeys = []
        executions = []

        # First use explicit runtime attributes.
        for name in (
            "business_journeys",
            "v83_business_journeys",
            "journeys",
            "discovered_business_journeys",
        ):
        ...
        for name in (
            ...
            "v83_business_journey_executions",
            "journey_executions",
        ):
            value = getattr(obj, name, None)
            if isinstance(value, list):
        ...
        # Then inspect common dictionaries/lists already held by the agent.
        containers = [
            getattr(obj, name, None)
            for name in (
                "business_journey_discovery",
                "business_journey_execution",
                "v83_discovery",
                "v83_execution",
                "journey_truth",
                "business_journey_truth",
            )
        ]
        ...
        for container in containers:
            ...
            if not journeys:
                for key in ("journeys", "discovered_journeys", "business_journeys"):
                    if isinstance(container.get(key), list):
                        journeys = container[key]
                        break
            ...
            if not executions:
                for key in (
                    ...
                    if isinstance(container.get(key), list):
                        executions = container[key]
                        break

        # Last fallback: existing result records.
        if not executions:
            for name in ("results", "test_results", "execution_results"):
                value = getattr(obj, name, None)
                if isinstance(value, list):
                    candidate = [
                        r for r in value
    ...
    journeys, executions = _v84_extract_journey_evidence(agent)

    journey_truth = {
        "journeys_discovered": len(journeys),
        "journeys_executed": len(executions),
        "journeys_failed": sum(
            r.get("status") == "FAIL" for r in executions
        ),
    }

    outcome_model = _v84_build_outcome_model(journeys, executions)
    release_truth = _v84_release_truth(outcome_model, journey_truth)
    _v84_write_truth(outcome_model, release_truth)
