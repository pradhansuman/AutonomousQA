...
REPORT_DIR = Path("qa_v5_2_report")
...
class QAAgent:
    ...
    async def _safe_candidate_locator(self, page, candidate):
        """
        Resolve an exploratory candidate deterministically.

        Priority:
          1. unique visible DOM id
          2. exact accessible role/name
          3. stable native attributes
        Never use nth() as a semantic fallback.
        """
    ...
    async def _safe_candidate_locator(self, candidate):
        """
    ...
    def report(self):
        ...
        print(
            "📊 V5.2 GOAL-DRIVEN AUTONOMOUS QA REPORT"
        )
...
async def main():
    print("\n*** RUNNING qa_agent_v5_1_DEFECT_INVESTIGATION_FINAL.py — VERSION 5.2 FINAL ***\n")
