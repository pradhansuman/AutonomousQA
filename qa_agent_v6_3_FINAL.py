...
REPORT_DIR = Path("qa_v6_3_report")
...
""".format(
    ...
    def _v63_print_reasoned_plan(self, plan):
        print("\n🧠 V6.3 REASONED EXPLORATION PLAN")
    ...
    def report(self):
        ...
        print(
            "📊 V6.3 REASONING ADAPTIVE AUTONOMOUS QA REPORT"
        )
