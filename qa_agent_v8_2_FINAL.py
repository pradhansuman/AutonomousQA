...
""".format(
    ...
    async def _v82_execute_generated_intents(self):
        ...
        # Do not duplicate generated execution if this run has already
        # materialized them.
        executed = []
        ...
        # Merge generated intent execution into the canonical test list.
        tests = state["execution"]["tests"]
