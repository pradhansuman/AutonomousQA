...
V83_RELEASE_MARKER = "V8.5-FINAL-HARDENED"
...
async def main():
    args = _v79_parse_cli()
    url = args.url
    print("\n*** RUNNING qa_agent_v8_5_AUTONOMOUS_BUSINESS_OUTCOME.py — VERSION 8.4 FINAL ***\n")
    ...
    # V8.5 consumes the already-executed journey evidence and verifies
    # business outcomes against observable UI/network/state evidence.
    ...
    if not executions:
        executions = [
            ...
            if isinstance(r, dict) and r.get("journey_id")
        ]
    ...
    # V8.5 consumes the already-executed journey evidence.
