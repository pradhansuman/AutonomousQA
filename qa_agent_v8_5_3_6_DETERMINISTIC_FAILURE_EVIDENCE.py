...
# ============================================================================
# V8.5.3.6 — TRUE OBSERVABILITY / EVIDENCE CORRELATION
# ============================================================================
V852_VERSION = "8.5.2"
...
def _v85_write_truth(model, truth):
    d=Path("qa_v8_5_3_6_report"); d.mkdir(parents=True,exist_ok=True)
    mp=d/"qa_business_outcome_verification_v8_5_3_6.json"; tp=d/"qa_v8_5_3_6_business_outcome_truth.json"
    ...
    print("\n"+"="*70); print("🧭 V8.5.3.6 TRUE OBSERVABILITY / BUSINESS-OUTCOME TRUTH"); print("="*70)
    ...
    print(f"\n   {'🟢' if truth['pass'] else '🔴'} V8.5.3.6 EVIDENCE TRUTH GATE: {'PASS' if truth['pass'] else 'FAIL'}"); print("="*70); print(f"📄 Outcome verification: {mp}"); print(f"📄 Outcome truth: {tp}")


# ============================================================================
# V8.5.3.6 — FAIL-CLOSED AUTONOMOUS EXECUTION INTEGRITY
# ============================================================================
#
...
def _v853_write_integrity_artifact(payload):
    report_dir = Path("qa_v8_5_3_6_report")
    report_dir.mkdir(parents=True, exist_ok=True)
    path = report_dir / "qa_execution_integrity_v8_5_3_6.json"
    path.write_text(
...
def _v853_print_blocked_truth(payload, artifact):
    print("\n" + "=" * 70)
    print("🛡️ V8.5.3.6 FAIL-CLOSED EXECUTION INTEGRITY")
    print("=" * 70)
...
# ============================================================================
# V8.5.3.6 — TARGETED JOURNEY & UNKNOWN-BEHAVIOR CLOSURE
# ============================================================================
#
# Scope:
...
def _v8533_write_closure_artifact(summary):
    report_dir = Path("qa_v8_5_3_6_report")
    report_dir.mkdir(parents=True, exist_ok=True)
    path = report_dir / "qa_targeted_closure_v8_5_3_6.json"
    path.write_text(
...
async def _v8533_run_targeted_closure(agent):
    ...
    print("\n" + "=" * 70)
    print("🎯 V8.5.3.6 TARGETED JOURNEY & UNKNOWN-BEHAVIOR CLOSURE")
    print("=" * 70)
...
# ============================================================================
# V8.5.3.6 — FAILURE REPRODUCTION & ENVIRONMENT/APPLICATION CLASSIFICATION
# ============================================================================
#
...
def _v8534_write_reproduction_artifact(target, records, classification):
    ...
    path = report_dir / "qa_failure_reproduction_v8_5_3_6.json"
    path.write_text(
        json.dumps(payload, indent=2, ensure_ascii=False, default=str),
        encoding="utf-8",
    )
...
async def _v8534_failure_reproduction(agent, target):
    ...
    try:
        ...
        print("\n" + "=" * 70)
        print("🔬 V8.5.3.6 FAILURE REPRODUCTION")
        print("=" * 70)
...
# ============================================================================
# V8.5.3.6 — FAILURE RECORD NORMALIZATION / CRASH-PROOF REPORTING
# ============================================================================
...
# ============================================================================
# V8.5.3.6 — DETERMINISTIC FAILURE EVIDENCE & JOURNEY REPRODUCTION
# ============================================================================
...
def _v8536_write_evidence(url, records, classification):
    ...
    path = report_dir / "qa_failure_evidence_v8_5_3_6.json"
    path.write_text(
        json.dumps(payload, indent=2, ensure_ascii=False, default=str),
        encoding="utf-8",
    )
...
async def _v8536_entrypoint_reproduction(agent, target):
    ...
    if browser is None:
        ...
        print("🔴 V8.5.3.6: browser handle unavailable")
        return result
    ...
    try:
        ...
        print("\n" + "=" * 70)
        print("🔬 V8.5.3.6 DETERMINISTIC FAILURE EVIDENCE")
        print("=" * 70)
...
async def main():
    ...
    print("\n*** RUNNING qa_agent_v8_5_3_6_FAIL_CLOSED_EXECUTION_INTEGRITY.py — VERSION 8.5.3.6 ***\n")

    if not url.startswith(("http://", "https://")):
        print("❌ Invalid URL")
        sys.exit(1)

    # CRITICAL V8.5.3.6 RULE:
    ...
    print("🛡️ V8.5.3.6 CURRENT-RUN DISCOVERY PREFLIGHT")
    ...
    if not _v853_connectivity_gate(preflight, target):
        ...
        print("🔴 V8.5.3.6 STOP: agent execution was NOT started.")
        raise SystemExit(3)
